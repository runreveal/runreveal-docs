...
1. **Timer Settings**
   - Use shorter timers (500ms) for time-sensitive tasks like queries and reports
   - Use longer timers (30s-60s) for background tasks like threat feeds and enrichments
...
3. **Visibility Timeout**
   - Set based on expected task duration
   - Include buffer time for retries and network latency
   - Typically 3-10 minutes depending on task complexity
