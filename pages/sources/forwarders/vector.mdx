...
- **[Filters](/logs/log-processing/filtering)** - Create custom filters to focus on specific security events
- **[Pipelines](/logs/log-processing/getting-started)** - Build data processing pipelines for complex workflows
