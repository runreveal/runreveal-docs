...
```
{
  ...
  "destinations": {
    ...
    "blobstore": {
      ...
      "pathPrefix": "logs/",
      // accessKeyID is required if not present in the environment as AWS_ACCESS_KEY_ID
      "accessKeyID": "AKIAIOS...",
      // secretAccessKey is required if not present in the environment as AWS_SECRET_ACCESS_KEY
