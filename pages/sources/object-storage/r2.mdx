---
title: 'Cloudflare R2 Bucket Configuration Guide'
description: 'This guide explains how to set up a Cloudflare R2 bucket as a data source for RunReveal. The setup requires two components:'
---
