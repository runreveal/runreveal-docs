...
Navigate to the [Connect a source](https://runreveal.com/dash/sources/add) page and find the source you are adding. Select the `Google Cloud Storage Bucket` ingest method and fill in the fields.
