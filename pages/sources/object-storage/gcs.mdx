---
title: 'Google Cloud Storage Ingestion'
description: 'This guide explains how to set up log ingestion from Google Cloud Storage (GCS) using either service account keys or workload identity federation with AWS.'
---
