...
description: 'Collect security events and threat detection data from Fastly Web Application Firewall.'
---
...
- [Fastly NGWAF Data Flows Documentation - Example Logs](https://docs.fastly.com/en/ngwaf/module-flows)
