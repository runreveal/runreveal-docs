...
Collect audit logs and events from your [PagerDuty](https://www.pagerduty.com/) account to monitor administrative changes and user activities. You'll find these logs in the `pagerduty_logs` table(s).
...
Your PagerDuty audit logs will be available in the `pagerduty_logs` table with the source type `pagerduty`.
