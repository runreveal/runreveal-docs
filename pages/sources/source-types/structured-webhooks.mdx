---
title: 'Structured Webhooks API'
description: 'RunReveal supports sending structured webhooks, events that match the format of the `runreveal.logs` table that we save all data to.'
---
