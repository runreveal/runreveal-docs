---
title: 'Deployment'
description: 'A Github Action is available to use in your Github workflows. You can find the source code for it at, [https://github.com/runreveal/detection-sync-action](https://github.com/runreveal/detection-sync-action).'
---
...
Now that you understand deployment workflows, explore these related guides:
