---
title: 'Getting Started with Detection As Code'
description: 'Detection as code relies on the RunReveal CLI. Downloading the CLI can be done'
---
...
Now that you're getting started with detection as code, explore these related guides:
