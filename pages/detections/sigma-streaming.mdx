...
description: 'RunReveal also offers [Sigma](https://sigmahq.io) streaming detections that can be checked while the event is being processed in the pipeline.'
---
...
- **[Test/Upload Detections](/detections/detection-as-code/uploading-detections)** - Learn how to test and deploy your Sigma detections
