...
1. Go to your RunReveal workspace
2. Navigate to **Settings** → **API Tokens**
3. Copy the token value (it will be in the format that works with the local MCP server)
4. Use this token value in your `RUNREVEAL_TOKEN` environment variable
