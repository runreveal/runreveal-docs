...
description: 'The Model Context Protocol (MCP) allows you to connect AI assistants like Claude and Cursor to external data sources and tools. This guide shows you how to set up RunReveal''s remote MCP server with both Claude and Cursor.'
---
