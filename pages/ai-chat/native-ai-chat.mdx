...
3. A modal will appear where you can input the arn of your IAM role and an External ID that you will add to your IAM role. If you've already configured a role with an External ID for RunReveal to assume, you can input the pre-existing ARN and External ID.
