...
A webhook source will generate a unique URL that can be used to forward events to. This URL is provided to the product and events are sent to RunReveal and processed.
