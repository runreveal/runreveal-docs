...
<div className="rounded-2xl bg-gradient-to-br from-primary-light to-purple-100 dark:from-primary/20 dark:to-purple-800/20 ring-1 ring-inset ring-primary/30 dark:ring-primary/50 overflow-hidden my-8">
  <div className="bg-primary px-6 py-3">
    <div className="text-white font-black flex items-center">
      <span className="mr-2">🛠️</span> Quick Start: Creating Your First Template
    </div>
  </div>
  <div className="p-6">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div className="flex items-start">
        ...
        <div>
          ...
          <div className="text-xs text-gray-600 dark:text-white">Go to Notification Channels → Templates</div>
        </div>
      </div>
      <div className="flex items-start">
    ...
    <div className="flex items-start">
      ...
      <div className="flex-1">
        ...
        <div className="bg-gray-50 dark:bg-gray-900/50 rounded p-3 text-xs text-gray-500 dark:text-gray-400">
          <strong>Path:</strong> Dashboard → Notification Channels → Templates
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
    <div className="flex items-start">
      ...
      <div className="flex-1">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mb-3">
          The template editor shows a <strong>Preview</strong> of how your markdown and formatting will render. Note that the preview displays your template structure with placeholder values—it does not use real detection data.
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            ...
            <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
              <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Markdown rendering</li>
              <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Template structure</li>
              <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Formatting validation</li>
            </ul>
          </div>
          <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Send Test Shows</div>
            <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
              <li className="flex items-center"><span className="text-blue-500 mr-2">✓</span> Real variable substitution</li>
              <li className="flex items-center"><span className="text-blue-500 mr-2">✓</span> Conditional logic evaluation</li>
              <li className="flex items-center"><span className="text-blue-500 mr-2">✓</span> Channel-specific formatting</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div className="flex items-start">
      ...
      <div className="flex-1">
        ...
        <div className="bg-accent-light dark:bg-accent/20 ring-1 ring-inset ring-accent/30 dark:ring-accent/50 rounded p-3 text-xs text-accent-dark dark:text-accent">
          <strong>💡 Tip:</strong> You can also specify templates in Detection-as-Code using the <code className="bg-accent-light dark:bg-accent/30 px-1 rounded">notificationTemplate</code> field.
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-700">
    <div className="p-6">
      ...
      <ol className="text-sm text-gray-600 dark:text-gray-400 space-y-2 list-decimal list-inside">
        <li>Go to Detections → Detection Queries</li>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 p-6 rounded-xl border ring-1 ring-inset ring-primary/30 dark:ring-primary/50">
    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3 flex items-center">
      <span className="mr-2">📌</span> Title Template
    </h3>
  ...
  <div className="bg-gradient-to-br from-insight-light to-blue-100 dark:from-insight/20 dark:to-blue-800/20 p-6 rounded-xl border ring-1 ring-inset ring-insight/30 dark:ring-insight/50">
    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3 flex items-center">
      <span className="mr-2">📄</span> Body Template
    </h3>
...
<div className="my-8">
  ...
  <div className="bg-accent-light dark:bg-accent/20 ring-1 ring-inset ring-accent/30 dark:ring-accent/50 rounded-lg p-4 my-4">
    <h5 className="font-semibold text-amber-900 dark:text-amber-200 mb-2 flex items-center">
      <span className="mr-2">💡</span> Example Use Cases
    </h5>
    <ul className="space-y-2 text-sm text-amber-800 dark:text-amber-300">
      <li>• Show critical alert banner only when severity equals "Critical"</li>
      <li>• Display high-risk warning when risk score is greater than 80</li>
      <li>• Show error message only when detection.error is not empty</li>
      <li>• Customize content based on channel type (email vs Slack)</li>
    </ul>
  </div>
</div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
      ...
      <ul className="space-y-2 text-xs text-gray-600 dark:text-gray-400">
        <li>• Loop through detection results</li>
        <li>• Iterate over categories array</li>
        <li>• Process MITRE techniques</li>
        <li>• Display extracted fields</li>
      </ul>
    </div>
    ...
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
      ...
      <ul className="space-y-2 text-xs text-gray-600 dark:text-gray-400">
        <li>• Always check ifNotEmpty before looping</li>
        <li>• Use index for numbering items</li>
        <li>• Use first/last for special formatting</li>
        <li>• Limit display to first N items if needed</li>
      </ul>
    </div>
  </div>
</div>
...
<div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-6 my-6">
  <h4 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100 flex items-center">
    <span className="mr-2">📝</span> Markdown Support
  </h4>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-5 rounded-r-lg">
    ...
    <ul className="space-y-2 text-sm text-green-800 dark:text-green-300">
      <li>• Keep titles concise (50-100 characters)</li>
      <li>• Always check ifNotEmpty before iterating</li>
      <li>• Include error handling sections</li>
      <li>• Provide investigation steps</li>
      <li>• Link to full results</li>
      <li>• Test with empty results</li>
  ...
  <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-5 rounded-r-lg">
    ...
    <ul className="space-y-2 text-sm text-red-800 dark:text-red-300">
      <li>• Assume results always exist</li>
      <li>• Create overly long titles</li>
      <li>• Skip error handling</li>
      <li>• Hard-code values that should be dynamic</li>
      <li>• Forget to test edge cases</li>
      <li>• Use complex nested conditionals unnecessarily</li>
      <li>• Ignore channel-specific formatting needs</li>
    </ul>
  </div>
</div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
          <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Simple variable syntax</li>
          <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Dot notation for nested properties</li>
          <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Markdown formatting support</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="p-6">
    ...
    <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 mb-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
        <div className="bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-3 py-2 rounded text-center">🚨 Critical</div>
        <div className="bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 px-3 py-2 rounded text-center">⚠️ High</div>
        <div className="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 px-3 py-2 rounded text-center">📋 Medium</div>
        <div className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-3 py-2 rounded text-center">ℹ️ Low</div>
      </div>
    </div>
  </div>
</div>
...
```handlebars copy
{{#ifEquals detection.severity "Critical"}}🚨 CRITICAL: {{/ifEquals}}{{#ifEquals detection.severity "High"}}⚠️ HIGH: {{/ifEquals}}{{#ifEquals detection.severity "Medium"}}📋 MEDIUM: {{/ifEquals}}{{#ifEquals detection.severity "Low"}}ℹ️ LOW: {{/ifEquals}}{{detection.displayName}}
```
...
```handlebars copy
{{#ifGreaterThan detection.riskScore 80}}🔴{{/ifGreaterThan}}{{#ifGreaterThan detection.riskScore 60}}{{#ifLessThan detection.riskScore 81}}🟠{{/ifLessThan}}{{/ifGreaterThan}}{{#ifLessThan detection.riskScore 61}}🟢{{/ifLessThan}} {{detection.displayName}}
```
...
```handlebars copy
{{#ifNotEmpty detection.error}}❌ Error: {{/ifNotEmpty}}{{detection.displayName}}
```
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
      ...
      <ul className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
        <li>• Empty results (resultCount = 0)</li>
        <li>• Single result</li>
        <li>• Multiple results (10+)</li>
    ...
    <div>
      ...
      <ul className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
        <li>• High risk scores (above 80)</li>
        <li>• Low risk scores (below 20)</li>
...
<div className="flex flex-wrap gap-4 my-6">
  <a href="/detections" className="inline-flex items-center px-4 py-2 bg-primary-light dark:bg-primary/20 text-primary dark:text-primary rounded-lg hover:bg-violet-200 dark:hover:bg-violet-900/50 transition-colors">
    <span className="mr-2">📚</span>
    Detection Documentation
  </a>
  <a href="/notifications" className="inline-flex items-center px-4 py-2 bg-insight-light dark:bg-insight/20 text-insight dark:text-insight rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors">
    <span className="mr-2">🔔</span>
