---
title: 'Slack'
description: 'To get started setting up your alerts you''ll need to create a slack webhook app, and provide us with the webhook url to start receiving your alerts. Don''t worry, this will only take a minute or two.'
---
