...
With routing, you can have more fine-grained control over the processing of your log events.  Topics allow you to
...
To manage your topics, you can head over to the [Routing Page](https://app.runreveal.com/dash/routing).
...
Clicking on the `Create Topic` button will bring you to the topc creation wizard which will walk you through setting
up your new topic.
...
routed to your topic.  Use the `Precondition Type` dropdown to set up your selection criteria.
...
select which events the step is appliled to.

Pipeline step types:

* **Transform**:  Apply a transformation to matching events, see the
[transform documentaion](https://docs.runreveal.com/transforms) for more details.
