...
3. **For Sigma detections (tests with local samples):**
   ...
   2. **Create sample data file:**
      ...
      You can copy whole events from RunReveal Dashboard and use it as is, or do the necessary changes to the data to ensure the detection will match what you are looking for.
...
- **[Pipelines](/logs/pipelines)** - Configure data processing workflows
