...
Follow the steps to set up your [remote MCP server connection](https://docs.runreveal.com/reference/model-context-protocol). Make sure that the Chat read and Chat write permissions are enabled.
