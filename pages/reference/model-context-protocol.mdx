...
To issue an API key go to Settings > API Keys and create a new API key with `Analyst` permissions. This allows the key to search logs but won't allow it to delete or create additional resources.
