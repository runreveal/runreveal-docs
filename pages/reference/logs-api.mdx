...
Authentication is done via basic auth with your API token.  Get your token by clicking "New API Token" on the page: [https://runreveal.com/dash/account](https://runreveal.com/dash/account) .
