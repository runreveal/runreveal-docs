---
title: 'Logs API'
description: 'Authentication is done via basic auth with your API token.  Get your token by clicking "New API Token" on the page: [https://app.runreveal.com/dash/workspace/api-tokens](https://app.runreveal.com/dash/workspace/api-tokens).'
---
