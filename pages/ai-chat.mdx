...
RunReveal's Scheduled Prompts feature allows you to automate AI-powered security analysis by running prompts on a schedule. This enables continuous monitoring, automated reporting, and proactive threat detection without manual intervention.

### Key Features
- **Automated Analysis**: Run AI prompts on a schedule using cron syntax
- **Multiple AI Providers**: Works with Anthropic, OpenAI, AWS Bedrock, and Google AI
- **Email Notifications**: Receive automated reports via email
- **Custom Model Support**: Add specific model versions for optimal performance
- **Security Focused**: All analysis happens within your secure RunReveal environment

### [Set Up Scheduled Prompts](./ai-chat/scheduled-prompts)

Learn how to create and manage scheduled prompts:
- Setting up automated security analysis
...
- **[Scheduled Prompts](./ai-chat/scheduled-prompts)** - For automated AI-powered security analysis
