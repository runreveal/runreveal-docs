---
title: 'Notifications'
description: 'RunReveal provides a comprehensive notification system that allows you to be alerted when your detection queries return results. This section covers all the notification options available to ensure your team stays informed about important security events.'
---
...
<Callout type="info">
  **New to notifications?** Check out our [Getting Started guide](./notifications/getting-started) for step-by-step instructions on setting up your first notification channels and adding them to your detections.
</Callout>
...
### [Google Chat Integration](./notifications/gchat)
Connect RunReveal to your Google Chat spaces to receive real-time alerts in your team channels.

### [Linear Integration](./notifications/linear)
Create Linear issues from RunReveal detections to streamline your security workflow and team collaboration.
