...
Authentication is done via basic auth with the user portion set to an empty string.  Get your token by clicking "New API Token" on the page: [https://runreveal.com/dash/account](https://runreveal.com/dash/account) .
